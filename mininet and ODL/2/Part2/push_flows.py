...
def create_payload(config):
  ...
  log_flows(payload, config["node_id"])
...
configs = []
configs.append({"node_id": 1, "table_id": 0, "flow_id": 1, "in-port": 1, "out-port": 2})
configs.append({"node_id": 1, "table_id": 0, "flow_id": 2, "in-port": 2, "out-port": 1})

# s2 
configs.append({"node_id": 2, "table_id": 0, "flow_id": 3, "in-port": 1, "out-port": 2})
configs.append({"node_id": 2, "table_id": 0, "flow_id": 4, "in-port": 2, "out-port": 1})

# r1
configs.append({"node_id": 3, "table_id": 0, "flow_id": 0, "ipv4-destination":"10.0.1.1/32", "in-port": 2, "out-port": 1})
configs.append({"node_id": 3, "table_id": 0, "flow_id": 1, "ipv4-destination":"10.0.2.1/32", "in-port": 1, "out-port": 2})
configs.append({"node_id": 3, "table_id": 0, "flow_id": 2, "arp-dst":"10.0.1.1/32", "in-port": 2, "out-port": 1})
configs.append({"node_id": 3, "table_id": 0, "flow_id": 3, "arp-dst":"10.0.2.1/32", "in-port": 1, "out-port": 2})
